...
local Default = "https://api.quran.com/api/v4/quran/verses/imlaei"
local ByChapter = "https://api.quran.com/api/v4/quran/verses/imlaei?chapter_number=%d"
local ByJuz = "https://api.quran.com/api/v4/quran/verses/imlaei?juz_number=%d"
local ByPage = "https://api.quran.com/api/v4/quran/verses/imlaei?page_number=%d"
local ByHizb = "https://api.quran.com/api/v4/quran/verses/imlaei?hizb_number=%d"
local ByRub = "https://api.quran.com/api/v4/quran/verses/imlaei?rub_number=%d"
local ByKey = "https://api.quran.com/api/v4/quran/verses/imlaei?verse_key=%s"
...
--- Get Imlaei script of ayah. Use query strings to filter results, leave all query string blank if you want to fetch Imlaei script of whole Quran.

...
local Default = "https://api.quran.com/api/v4/quran/verses/uthmani_simple"
local ByChapter = "https://api.quran.com/api/v4/quran/verses/uthmani_simple?chapter_number=%d"
local ByJuz = "https://api.quran.com/api/v4/quran/verses/uthmani_simple?juz_number=%d"
local ByPage = "https://api.quran.com/api/v4/quran/verses/uthmani_simple?page_number=%d"
local ByHizb = "https://api.quran.com/api/v4/quran/verses/uthmani_simple?hizb_number=%d"
local ByRub = "https://api.quran.com/api/v4/quran/verses/uthmani_simple?rub_number=%d"
local ByKey = "https://api.quran.com/api/v4/quran/verses/uthmani_simple?verse_key=%s"
